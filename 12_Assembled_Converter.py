...
class Converter: 
    ...
    def temp_convert (self, low):
        ...
        error = "#ffafaf"   # pale pink background for when the entry box has errors
...
class History:
    def __init__(self, partner, calc_history):
        ...
        # If users press cross at the top, closes help and 'releases' history button
...
class Export:
    def __init__(self, partner, calc_history):
        ...
        background = "#FF9A57"    #light orange
...
class Help:
    def __init__(self, partner):
        ...
        self.help_text = Label(self.help_frame, text="Enter a number in the box "
                                                     ...
                                                     "to convert to either degrees "
                                                     "Celsius (deg C) or degrees "
                                                     "Fahrenheit (deg F). Note that the "
                                                     "number you put in should be more than absolute.\n\n"
